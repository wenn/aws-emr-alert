...
class SparkClientSpec
  ...
  it must "build message from terminated event" in new Fixture {
    ...
    val expected =
      """**Development Cluster**: j-1YONHTCP3YZKC - TERMINATED *at 2016-12-16T21:00:23Z*
  ...
  it must "build message from starting event" in new Fixture {
    ...
    val expected = s"**Development Cluster**: j-1YONHTCP3YZKC - STARTING *at 2016-12-16T21:00:23Z*"
